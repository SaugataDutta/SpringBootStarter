...
public class KafkaController {
    ...
    public KafkaRequestObject getMessageFromTopic(@RequestParam(value ="topic_name") String topic_name, @RequestParam(name = "partition") int partition, @RequestParam(name="offset") long offset, @AuthenticationPrincipal
                                                  AuthenticatedUser user) throws
            JsonProcessingException {
        System.out.println("Service Call for User : "+user.getFirstName());
